from plugins.arcaea.aua.schema import SongRandom, AUASongInfo
from plugins.arcaea.resource_manager import assets_root
...
class TextMessage:
    ...
    def song_info_detail(data: SongRandom):
        ...
        image = str(assets_root / "song" / content.id / cover_name)
        result = "\n".join(
            [
