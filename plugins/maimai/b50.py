...
from plugins.maimai.music import total_list, get_cover_len4_id
...
class DrawBest(object):
    ...
    def _drawBestList(self, img: Image.Image, sdBest: BestList, dxBest: BestList):
        ...
        titleFontName = 'assets/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype('assets/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text((8, 44), f'Base: {chartInfo.ds} -> {computeRa(chartInfo.ds, chartInfo.achievement)}', 'white',
                          font)
            font = ImageFont.truetype('assets/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype('assets/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype('assets/adobe_simhei.otf', 14, encoding='utf-8')
